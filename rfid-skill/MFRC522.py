...
class MFRC522:
    ...
    def __init__(self, bus=0, device=0, spd=1000000, debugLevel='WARNING'):
        MFRC522.spi.open(bus, device)
        MFRC522.spi.max_speed_hz = spd
    ...
    def Write_MFRC522(self, addr, val):
        val = MFRC522.spi.xfer2([(addr << 1) & 0x7E, val])

    def Read_MFRC522(self, addr):
        val = MFRC522.spi.xfer2([((addr << 1) & 0x7E) | 0x80, 0])
        return val[1]

    def Close_MFRC522(self):
        print("Inside Closing SPI")
        MFRC522.spi.close()
